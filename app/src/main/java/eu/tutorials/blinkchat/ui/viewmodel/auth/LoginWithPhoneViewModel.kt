    ...
    fun onEvent(event: LoginWithPhoneEvent) {
        when (event) {
            ...
            is LoginWithPhoneEvent.EnterVerificationCode -> {
                _loginWithPhoneState.value = _loginWithPhoneState.value.copy(verificationCode = event.verificationCode, verificationError = null)
            }
            ...
            is LoginWithPhoneEvent.VerifyCode -> {
                _loginWithPhoneState.value = _loginWithPhoneState.value.copy(verificationError = null)
